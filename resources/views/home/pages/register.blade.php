...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/home/styles/register.css')}}">
</head>
<body>
    <div class="content">
            ...
            <div class="container__child signup__form">
                <form action="{{route('home.post.register')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="username" id="username" placeholder="james.bond"  />
                        @error('username')
                    ...
                    <div class="form-group">
                        ...
                        @error('passwordRepeat') <span class="red">{{$message}}</span> @enderror
                    </div>
                    <div class="m-t-lg">
                        <ul class="list-inline">
                            ...
                            <li>
                                <a class="signup__link" href="{{route('home.login')}}">Login</a>
                            </li>
                        </ul>
                    </div>
                </form>
